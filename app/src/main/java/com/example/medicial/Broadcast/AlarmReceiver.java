...
public class AlarmReceiver extends BroadcastReceiver {
    public static final String TYPE_ONE_TIME = "Take your medicine";
    public static final String TYPE_REPEATING = "RepeatingAlarm";
    public static final String EXTRA_MESSAGE = "Hello, its time to take your medicine";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int notificationId = type.equalsIgnoreCase(TYPE_ONE_TIME) ? ID_ONETIME : ID_REPEATING;
